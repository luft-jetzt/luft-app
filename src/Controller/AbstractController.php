...
abstract class AbstractController extends FrameworkAbstractController
{
    ...
    {
        return $this->managerRegistry->getRepository(Station::class)->findActiveStationsForCity($city);
    }
    ...
    {
        return $this->managerRegistry->getRepository(City::class)->findOneBySlug($citySlug);
    }
